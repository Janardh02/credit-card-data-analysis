...
with DAG(
    ...
    gcs_bucket = "credit-card-data-analysis-2026"
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://credit-card-data-analysis-2026/spark_job/spark_job.py"
        },
        "runtime_config": {
            "version": "2.2",
        },
        "environment_config": {
            "execution_config": {
                ...
                "subnetwork_uri": "projects/electric-totem-476812-e6/regions/us-east1/subnetworks/default",
            }
        },
    }
